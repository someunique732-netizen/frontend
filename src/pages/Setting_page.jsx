  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-8 hover:scale-105 transition-all duration-300">
          ...
          <div className="flex justify-between items-start">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-4">
                Manage company name, logo, QR code and bill information
              </p>
            </div>
          ...
          <button
            ...
            className="mt-8 w-full bg-cyan-500 text-white py-4 rounded-2xl font-semibold hover:bg-cyan-600 transition"
          >
            Company Settings
          </button>
        ...
        {/* Logout */}
        <div className="bg-gradient-to-r from-red-500 to-orange-500 rounded-3xl p-8 hover:scale-105 transition-all duration-300">
